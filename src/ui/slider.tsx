...
export const NextArrow = ({ currentSlide, slideCount,onClick,className, ...props }: ArrowProps) => (
  <RightOutlined className={`text-blue-500 text-base xs:text-lg transition-all flex items-center justify-center ${className}`} onClick={onClick}/>
);
export const PrevArrow = ({ currentSlide, slideCount,onClick,className, ...props }: ArrowProps) => (
  <LeftOutlined className={`text-blue-500 text-base xs:text-lg transition-all flex items-center justify-center ${className}`} onClick={onClick}/>
);
